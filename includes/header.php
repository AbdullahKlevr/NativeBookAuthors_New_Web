    ...
    <div class="text-white fs-15 position-relative" style="background-color : black; z-: 1;">
        <div class="container py-2 d-flex">
            ...
            <div id="hideinmobile"
                ...
                <p class="mb-0"> <a href="#" class="text-white"> <i class="fa-brands fa-facebook"></i> </a></p>
                &nbsp;&nbsp;&nbsp;
                <p class="mb-0"><a href="#" class="text-white"> <i class="fa-brands fa-instagram"
                            aria-hidden="true"></i> </a></p> &nbsp;&nbsp;&nbsp;
                <p class="mb-0"><a href="#" class="text-white"> <i class="fa-brands fa-pinterest"
                            aria-hidden="true"></i> </a></p> &nbsp;&nbsp;&nbsp;
                <p class="mb-0"><a href="#" class="text-white"> <i class="fa-brands fa-linkedin" aria-hidden="true"></i>
                    </a></p> &nbsp;&nbsp;&nbsp;
            </div>
        </div>
    </div>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown dropdown-single">
                        ...
                        <ul class="dropdown-menu dropdown-menu-single dropdown-menu-single4"
                            ...
                            <li>
                                <a class="dropdown-item" href="/amazon-book-publishing">Amazon Book Publishing</a>
                                <a class="dropdown-item" href="/book-publishing-services">Book Publishing</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown dropdown-single">
                        ...
                        <ul class="dropdown-menu dropdown-menu-single dropdown-menu-single3"
                            aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="/book-editing">Books Editing</a>
                                <a class="dropdown-item" href="/book-formatting">Book Formatting</a>
                                <a class="dropdown-item" href="/children-book-editing">Children's Book Editors</a>
                                <a class="dropdown-item" href="/book-proofreaders">Book Proofreading</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown dropdown-single">
                        ...
                        <button class="dropdown-icon-btn" id="dropIconToggle1"><i class="fa-chevron-down fas"></i></button>
                        <ul class="dropdown-menu dropdown-menu-single dropdown-menu-single1">
                            <li>
                                ...
                                <a class="dropdown-item" href="/author-website-design">Author Website Design</a>
                                <a class="dropdown-item" href="/children-book-printing">Children Book Printing</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown-single">
                        <a class="nav-link " href="/book-marketing-company" id="navbarDropdown">Book Marketing</a>
                    </li>
                    <li class="nav-item dropdown dropdown-single">
                        <a class="nav-link " href="void:;" id="navbarDropdown">Other Services</a>
                        <button class="dropdown-icon-btn" id="dropIconToggle7"><i class="fa-chevron-down fas"></i></button>
...
<style>
    .dropdown-menu-single1,
    .dropdown-menu-single7 {
        display: none; /* Hide by default */
    }
    .dropdown-menu-single1.show,
    .dropdown-menu-single7.show {
